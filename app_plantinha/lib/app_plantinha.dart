...
import 'package:app_plantinha/view/pages/take_picture_page.dart';
...
class AppPlantinha extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      '/settingsPage/accountSettingsPage': (context) => const AccountSettingsPage(title: 'Account Settings Page'),
      '/settingsPage/accountSettingsPage/changePasswordPage': (context) => const ChangePasswordPage(title: 'Change Password Page'),
      '/settingsPage/appSettingsPage': (context) => const AppSettingsPage(title: 'App Settings Page'),
      '/helpPage': (context) => const HelpPage(title: 'Help Page'),
      '/historyPage': (context) => const HistoryPage(title: 'History Page'),
      '/splashScreenPage': (context) => const SplashScreenPage(title: 'Splash Screen Page'),
      },
      title: 'Material App',
      ...
      colorScheme: ColorScheme.fromSeed(
        ...
        brightness: Provider.of<LightDarkState>(context).tema == 'light' || ModalRoute.of(context)?.settings.name == '/'
          ? Brightness.light
          : Brightness.dark,
        contrastLevel: 0,
      ),
