...
var HistoricoController = /** @class */ (function () {
    function HistoricoController(limpsrHistoricoUseCase, obterHistoricoUseCase) {
        var _this = this;
        this.limpsrHistoricoUseCase = limpsrHistoricoUseCase;
        this.obterHistoricoUseCase = obterHistoricoUseCase;
        this.obterHistorico = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id;
        ...
        this.limparHistorico = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var id;
            return __generator(this, function (_a) {
                try {
                    id = req.params.id;
